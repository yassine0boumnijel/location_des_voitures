...
<head>
  ...
  <title>Yasine&Aymen RajiCars - Page principale</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-sm-4">
          ...
          <hr class="botm-line">
          <p>Il n’a jamais été aussi facile et rapide de louer sa voiture a la Tunisie. 
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          ...
          <div class="testi-info">
            ...
            <a href="#"><img src="img/thumb.png" alt="" class="img-responsive"></a>
            <!-- User Name -->
            <h3>Hedi<span>Sousse</span></h3>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
          <div class="testi-details">
            <!-- Paragraph -->
            <p>m3alemin service tayara.</p>
          </div>
          <div class="testi-info">
            <!-- User Image -->
            <a href="#"><img src="img/thumb.png" alt="" class="img-responsive"></a>
            <!-- User Name -->
            <h3>Rami<span>Algerie</span></h3>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>Route 404 <br> Bizerte - Tunisie</p>
          <div class="space"></div>
          <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>Yassineboumnijel@gmail.com</p>
          <div class="space"></div>
          <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+216 22222222</p>
        </div>
        ...
        <div class="row">
          ...
          © 2023 | Y&A Raji Cars
            <div class="credits">
              ...
              -->
              Réalisé par <a href="https://isg.com/">Yassine &Aymen</a>
            </div>
          </div>
        </div>
      </div>
