...
<head>
  ...
  <title>Yassine aymen Cars - Page principale</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-sm-4">
          ...
          <hr class="botm-line">
          <p>Il n’a jamais été aussi facile et rapide de louer sa voiture au Bizerte. 
               ...
               Consultez notre site pour voir les voitures présentes et faites votre choix.
                Depuis plusieurs années, Avis vous accompagne dans la location de voiture a la Tunisie. 
          ...
          <div style="visibility: visible;" class="col-sm-9 more-features-box">
            <div class="more-features-box-text">
              ...
              <div class="more-features-box-text-description">
                <h3>Rajicars</h3>
                <p>Yassie aymen CARS, avec un groupe commercial, jeune, énergique et disponible à tout moment a pour activité principale: la location de voitures légères, 4x4, minibus et bus climatisés. Grâce aux voitures haut de gamme, neuves et très bien entretenues; et avec l'aide de chauffeurs expérimentés, Yassine aymen CARS dispose de moyens de communication crédibles pour rester en contact à tout moment. En cas de panne, votre voiture est immédiatement remplacée dans les 24 heures. Nous avons également la possibilité de vous louer des voitures dans toutes les villes du la Tunisie à l'endroit, à l'heure et le jour de votre convenance; et votre voiture vous attendra à l'aéroport de votre choix. Avec plusieurs années d'expérience dans le secteur de la location de voitures a la Tunisie, Notre agence propose des prix abordables à court ou à long terme. Pour plus d'informations n'hésitez pas à nous contacter. Pourquoi choisir Nous ? Nouvelles voitures; Les assurances (tous risques) sont incluses dans le prix. Le kilométrage est illimité.</p>
              </div>
            </div>
...
<p>Avantage cars assure vos transferts depuis l'aéroport vers votre Hôtel, PALACE ou au lieu de résidence. Ces frais sont facturables et varies selon la ville de destination.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          ...
          <div class="testi-info">
            ...
            <a href="#"><img src="img/thumb.png" alt="" class="img-responsive"></a>
            <!-- User Name -->
            <h3>Ahmed<span>Texas</span></h3>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
          <div class="testi-details">
            <!-- Paragraph -->
            <p>je suis tres satisfait.</p>
          </div>
          <div class="testi-info">
            <!-- User Image -->
            <a href="#"><img src="img/thumb.png" alt="" class="img-responsive"></a>
            <!-- User Name -->
            <h3>Fehed<span>Texas</span></h3>
          </div>
        </div>
      </div>
    </div>
